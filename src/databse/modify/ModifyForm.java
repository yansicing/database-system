...
public class ModifyForm extends JFrame implements ActionListener
{
  ...
  public void actionPerformed(ActionEvent ae)
  {
      ...
      else if(ae.getSource()==btnModify)
      {
          try
          {
              System.out.println("Update  Custom set Cname="+txtName.getText()+",Csex="+txtSex.getText()+",Cphone="+txtTel.getText()+",Caddress="+txtAddress.getText()+" where Cno='"+txtNum.getText()+"'");
              stm.executeUpdate("Update  Custom set Cname='"+txtName.getText()+"',Csex='"+txtSex.getText()+"',Cphone='"+txtTel.getText()+"',Caddress='"+txtAddress.getText()+"' where Cno='"+txtNum.getText()+"'");
